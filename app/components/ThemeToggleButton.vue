<template>
  <button
    type="button"
    class="btn btn-icon p-0 rounded-3 border"
  ...
  >
    ...
    <svg v-if="isDark" viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
